...
| :------------------------- | :---------------------------------------------------------------------- | :--------------------------------------------------------------------------- | :---------------------------------------------------------- |
| **無音トリミング**         | $\mathcal{O}(N \cdot W)$                                                | $\mathcal{O}(N)$（特徴抽出）<br>$\mathcal{O}(1)$（音声スライス時）           | 局所エネルギーの累積和系列 ＆ EnergyMap (第2章)             |
...
| **逆変換：音声スライス計算** | $\mathcal{O}(K^2)$                                                      | $\mathcal{O}(K)$                                                             | 逆順DPによる時間状態伝搬 (第1章)                            |
