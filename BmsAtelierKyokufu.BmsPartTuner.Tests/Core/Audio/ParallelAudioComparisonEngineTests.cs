...
namespace BmsAtelierKyokufu.BmsPartTuner.Tests.Core.Audio
{
    ...
    public class ParallelAudioComparisonEngineTests
    {
        ...
        public void CompareGroups_IdenticalFiles_UpdatesReplaceTable()
        {
            ...
            engine.CompareGroups(groups, 0.99f, new BmsAtelierKyokufu.BmsPartTuner.Core.Context.OperationContext(new Progress<int>()));
        ...
        public void CompareGroups_SimilarFiles_UpdatesReplaceTable()
        {
            ...
            // 類似度が高い場合、2は1に置換される
            engine.CompareGroups(groups, 0.90f, new BmsAtelierKyokufu.BmsPartTuner.Core.Context.OperationContext(new Progress<int>()));
