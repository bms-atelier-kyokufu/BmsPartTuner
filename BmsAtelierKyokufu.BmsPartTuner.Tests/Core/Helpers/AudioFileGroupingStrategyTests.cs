...
public class AudioFileGroupingStrategyTests
{
    ...
    public void GroupFiles_EmptyList_ReturnsEmptyGroups()
    {
        ...
        // Act
        var groups = AudioFileGroupingStrategy.GroupFiles(audioCache, files, 1, 10);
    ...
    public void GroupFiles_OutsideRange_ExcludesFiles()
    {
        ...
        // Act
        var groups = AudioFileGroupingStrategy.GroupFiles(audioCache, files, 1, 3); // 1-3の範囲のみ
    ...
    public void GroupFiles_WithKeywords_SeparatesInstruments()
    {
        ...
        // Act
        var groups = AudioFileGroupingStrategy.GroupFiles(audioCache, files, 1, 4, keywords);
    ...
    public void GroupFiles_WithEmptyKeywords_UsesTraditionalGrouping()
    {
        ...
        // Act
        var groups = AudioFileGroupingStrategy.GroupFiles(audioCache, files, 1, 2, emptyKeywords);
    ...
    public void GroupFiles_WithNullKeywords_UsesTraditionalGrouping()
    {
        ...
        // Act
        var groups = AudioFileGroupingStrategy.GroupFiles(audioCache, files, 1, 2, null);
    ...
    public void GroupFiles_SingleFile_ReturnsOneGroup()
    {
        ...
        // Act
        var groups = AudioFileGroupingStrategy.GroupFiles(audioCache, files, 1, 1);
    ...
    public void GroupFiles_FileWithNullName_HandlesGracefully()
    {
        ...
        // Act
        var groups = AudioFileGroupingStrategy.GroupFiles(audioCache, files, 1, 2);
